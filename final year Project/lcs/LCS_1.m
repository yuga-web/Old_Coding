%function [ dist, aLongestString] = LCS(X,Y)
...
%seqsample=fastaread('Downloads\data_1.fasta','ignoregaps',true)
seqsample=fastaread('Downloads\dna2.fasta','ignoregaps',true)
